    ...
    <footer className="h-[50px] px-10  flex w-full justify-around items-center bg-zinc-800">
        ...
        <div className='flex gap-6'>
            <svg
                ...
                className="h-7 w-7 text-[#1877f2] cursor-pointer hover:text-white"
                fill="currentColor"
                viewBox="0 0 24 24">
                <path
            ...
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7 text-[#ff0000] cursor-pointer hover:text-white"
                fill="currentColor"
                viewBox="0 0 24 24">
                <path
            ...
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-7 w-7 text-[#1da1f2] cursor-pointer hover:text-white"
                fill="currentColor"
                viewBox="0 0 24 24">
                <path
