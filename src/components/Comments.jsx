    ...
    return (
        <div className="flex flex-col w-11/12 mb-6 p-2 text-sm border border-gray-400 rounded-xl shadow-lg">
            ...
            <div className="flex items-center">
                <img className="inline select-none mr-3 ring-1 ring-purple-600 ring-offset-1 rounded-full object-cover w-8 h-8 group-hover:drop-shadow-md" src={ user.photo } alt="profile photo" />
                <form className="flex w-full relative">
                    <input ref={inputComment} maxLength={200} className="flex pl-4 pr-14 py-3 w-full outline-none bg-gray-300 rounded-full text-base focus:outline-teal-500 focus:bg-slate-100" type="text" placeholder="Leave a comment..." />
