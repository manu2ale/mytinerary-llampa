        ...
        <main className="flex grow justify-center items-center  bg-cover bg-center" style={{backgroundImage: `url(${'../img/index.jpg'})`}}>
          <section className='bg-white/50 backdrop-blur rounded-xl p-2 flex font-bold text-lg justify-between items-center flex-wrap min-[1367px]:w-[80%]'>
            <div className=''>
              ...
              <p className='my-8 max-w-[628px] text-2xl text-gray-700 font-semibold'>Our app will help you find the perfect path for your next trip. With an easy-to-use interface and a host of itinerary options, planning your next trip has never been easier.</p>
